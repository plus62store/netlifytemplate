...
var cart_kosong = '<div class="empty-cart"><center><i class="fa fa-shopping-basket" style="font-size:90px;"></i><span class="center"><br /><p />Keranjang Belanja Kosong</span></div></center>';
        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                jumlah: function (item, column) {
                    return ["<span class='jumlah'>Jumlah " + item.get(column.attr) + " pcs</span>"];
                },
